  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full bg-white dark:bg-zinc-900/90 backdrop-blur-xl rounded-[2rem] overflow-hidden">
        ...
        {/* Image Section — wider landscape ratio on sm+, standard on mobile */}
        <div className="relative w-full aspect-[16/10] sm:aspect-[16/7] overflow-hidden bg-zinc-100 dark:bg-zinc-800 border-b border-black/5 dark:border-white/5">
          <Motion.img
            src={img}
            alt={title}
            loading="lazy"
        ...
        <div className="flex-1 flex flex-col p-6 sm:p-7 bg-white dark:bg-zinc-900">
          ...
          <p className="text-black/60 dark:text-white/60 text-sm leading-relaxed mb-4 flex-1">
            {desc}
          </p>
          ...
          <div className="flex flex-wrap gap-1.5 mb-5">
            {tech.map((t, i) => (
              <span
                key={i}
                className="px-2.5 py-1 text-[10px] font-bold uppercase tracking-wide rounded-md bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400 border border-zinc-200 dark:border-zinc-700 transition-colors group-hover:border-black/20 dark:group-hover:border-white/20"
              >
                {t}
              </span>
            ))}
          ...
          {/* Action Buttons */}
          <div className="flex items-center gap-3 pt-5 border-t border-black/5 dark:border-white/10 mt-auto">
            <Motion.a
              href={site}
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-bold text-white bg-black dark:bg-white dark:text-black shadow-md hover:shadow-lg transition-all duration-200 hover:scale-[1.03] active:scale-[0.97]"
            >
            ...
            <Motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-bold text-black dark:text-white border-2 border-black/10 dark:border-white/10 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-all duration-200 hover:scale-[1.03] active:scale-[0.97]"
            >
